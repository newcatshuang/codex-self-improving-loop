const params = new URLSearchParams(location.search);
    ...
    const translations = {
      en: {
        ...
        nextRunTimeText: "Next run: daily 01:00",
        ...
        scheduleDesc: "Install or remove the daily 01:00 scan and desktop WebUI launcher. The scheduled task runs sil.py scan --once.",
        ...
        confirmInstallSchedule: {
          action: "Install or replace the daily 01:00 self-improvement scan schedule.",
          ...
          result: "The scan will run automatically each day at 01:00 without keeping the WebUI open.",
        },
      ...
      zh: {
        ...
        nextRunTimeText: "下一次运行：每天 01:00",
        lastRunTitle: "最近运行结果",
        ...
        recallButton: "搜索",
        scheduleCenter: "调度中心",
        scheduleDesc: "安装或移除每天 01:00 的扫描任务和桌面 WebUI 快捷方式。定时任务会运行 sil.py scan --once。",
